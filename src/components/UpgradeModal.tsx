        ...
        <div className="upg-card">
          ...
          {step === 1 && (
            <>
              ...
              <div className={`plan-card ${planoSeleccionado === 'mensal' ? 'active' : ''}`} onClick={() => handlePlanoSelect('mensal')}>
                <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center' }}>
                  ...
                  <div style={{ textAlign:'right', flexShrink:0, paddingLeft:'1rem' }}>
                    <div style={{ fontFamily:"'Russo One',sans-serif", fontSize:'1.5rem', color:'#FFD700' }}>2.500 Kz</div>
              ...
              {/* Plano Anual */}
              <div className={`plan-card ${planoSeleccionado === 'anual' ? 'active' : ''}`} onClick={() => handlePlanoSelect('anual')}>
                <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center' }}>
                  <div>
                  ...
                  <div style={{ textAlign:'right', flexShrink:0, paddingLeft:'1rem' }}>
                    <div style={{ fontFamily:"'Russo One',sans-serif", fontSize:'1.5rem', color:'#FFD700' }}>20.000 Kz</div>
          ...
          {step === 2 && (
            <>
              ...
              <div style={{
                ...
                <p style={{ margin:'0 0 0.75rem', fontWeight:700, color:'#FFD700' }}>📋 DADOS BANCÁRIOS</p>
              ...
              <div style={{
                ...
                📧 Após pagamento, envia o comprovativo para <strong style={{color:'#FFD700'}}>glowscalepro@gmail.com</strong><br/>
          ...
          {step === 3 && (
            <>
              ...
              <div style={{
                ...
                <p style={{ fontFamily:"'Russo One',sans-serif", fontSize:'1.4rem', color:'#FFD700', letterSpacing:'0.05em' }}>
                  {referencia}
                </p>
              </div>

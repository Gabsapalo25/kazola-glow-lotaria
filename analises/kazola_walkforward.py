"""
MÉTODO KAZOLA — WALK-FORWARD VALIDATION (CORRIGIDO)
Recalcula o método para CADA sorteio de teste usando dados atualizados
"""
...
def main():
    print("\n🔬 MÉTODO KAZOLA — WALK-FORWARD VALIDATION")
    print("=" * 70)
    ...
    print("\n📊 RESULTADOS POR SESSÃO (Walk-Forward)")
    print("-" * 70)
    ...
    for sessao in sessoes:
        ...
        # WALK-FORWARD: recalcula para cada sorteio
        ...
        for sorteio in teste_sessao:
            ...
            # Método Kazola (recalculado com dados atualizados)
            combinacoes = metodo_kazola(dados_disponiveis)
            for comb in combinacoes:
                if len(set(comb) & numeros_reais) >= 2:
                    acertos_kazola += 1
                    break
            
            # Adiciona o sorteio aos dados disponíveis para o próximo
        ...
        if taxa_kazola > taxa_aleatorio:
            print(f"      ✅ Kazola supera o aleatório")
        else:
            print(f"      ❌ Kazola não supera o aleatório")
    
    print("\n" + "=" * 70)
    print("  WALK-FORWARD VALIDATION:")
    print("  O método é recalculado para CADA sorteio de teste")
    print("  Simula o uso real: previsão adaptativa ao longo do tempo")
    print("=" * 70)
